...
then
      ...
      docker build -t $image_name --build-arg master_port=$master_port --build-arg agent_port=$agent_port --build-arg VAULT_PWD=$vault_pass --build-arg jenkins_version=$jenkins_version  --build-arg jenkins_master_run_cmd="$jenkins_version_run_cmd" .
else
